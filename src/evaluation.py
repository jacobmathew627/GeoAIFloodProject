...
class FloodEvaluationMetrics:
    ...
    def compute_all_metrics(self):
        ...
        try:
            ...
            # sklearn raises ValueError when target_binary is single-class
            # (e.g. an all-dry evaluation window) -- ROC/PR AUC are undefined
            # there, not zero, but 0.0 is what every caller of this class
            # already expects for "could not score".
            metrics["roc_auc"] = 0.0
            metrics["pr_auc"] = 0.0
